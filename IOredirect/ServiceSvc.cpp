...
void myDone()
{
  ...
  default:
    ...
    //error/cleanup - close all handles
  }
}
...
void __cdecl Service(int argc, TCHAR *argv[])
{
  ...
  {
    printf("StartServiceCtrlDispatcher fail with %d \n", GetLastError());
    //SvcReportEvent(TEXT("StartServiceCtrlDispatcher fail"));
  }
}
